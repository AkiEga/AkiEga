...
- [vscode-extension-section-info](https://github.com/AkiEga/vscode-extension-section-info) — Copies selected code sections to the clipboard with customizable file, line, function, and Git metadata
...
- [vscode-msvs-proj-manager](https://github.com/AkiEga/vscode-msvs-proj-manager) — Parses Visual Studio .sln files in VS Code and opens terminals in each project's root directory
