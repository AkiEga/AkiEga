...
- [vscode-extension-section-info](https://github.com/AkiEga/vscode-extension-section-info) — Copies selected code section details and text to the clipboard in customizable formats with Git metadata
- [vscode-extension-svg-sketch](https://github.com/AkiEga/vscode-extension-svg-sketch) — Canvas-based VS Code editor for creating and editing SVG diagrams, with clipboard support and Vim modes
- [vscode-extension-tree](https://github.com/AkiEga/vscode-extension-tree) — Run the tree command on folders in VS Code and view the file tree in an editor or webview
- [vscode-msvs-proj-manager](https://github.com/AkiEga/vscode-msvs-proj-manager) — Helps manage Visual Studio solutions in VS Code by parsing .sln files and opening terminals in project roots
