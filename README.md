...
#### VS Code Extensions
- [file-open-history](https://github.com/AkiEga/file-open-history) — Shows your VS Code file-opening history in an editor pane or output channel
...
- [vscode-extension-section-info](https://github.com/AkiEga/vscode-extension-section-info) — Copies selected code sections with file, line, function, and Git metadata to the clipboard in customizable formats
...
- [vscode-extension-tree](https://github.com/AkiEga/vscode-extension-tree) — Run tree on folders in VS Code and view the output in an editor or side panel
