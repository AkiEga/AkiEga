...
- [vscode-extension-section-info](https://github.com/AkiEga/vscode-extension-section-info) — Copies selected code section details and customizable file, line, and Git context to the clipboard
...
- [vscode-extension-tree](https://github.com/AkiEga/vscode-extension-tree) — Displays a folder's tree command output in VS Code as an editable tab or side-by-side webview
- [vscode-msvs-proj-manager](https://github.com/AkiEga/vscode-msvs-proj-manager) — Manage Visual Studio solution files in VS Code by parsing .sln files and opening terminals in project roots
