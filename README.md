...
#### VS Code Extensions
- [file-open-history](https://github.com/AkiEga/file-open-history) — Tracks and displays your VS Code file open history in a text editor or output channel
...
- [vscode-extension-section-info](https://github.com/AkiEga/vscode-extension-section-info) — Copies selected code sections and related file, line, and Git info to the clipboard in custom formats
...
- [vscode-extension-tree](https://github.com/AkiEga/vscode-extension-tree) — A VS Code extension that runs tree on folders and shows the file tree in an editor or webview
