...
- [vscode-extension-ascii-sketch](https://github.com/AkiEga/vscode-extension-ascii-sketch) — A VS Code extension for creating and editing ASCII art with .ascii support, canvas creation, and box tools
- [vscode-extension-section-info](https://github.com/AkiEga/vscode-extension-section-info) — Copies selected code sections and contextual file, line, and Git info to the clipboard in custom formats
...
- [vscode-extension-tree](https://github.com/AkiEga/vscode-extension-tree) — A VS Code extension that runs tree on folders and shows the results in an editor or webview
