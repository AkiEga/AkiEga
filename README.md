...
#### VS Code Extensions
- [file-open-history](https://github.com/AkiEga/file-open-history) — Tracks and displays the history of files you open in VS Code
...
- [vscode-extension-tree](https://github.com/AkiEga/vscode-extension-tree) — Displays a folder's tree command output in VS Code as an editor tab or side webview
