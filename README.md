...
#### VS Code Extensions
- [file-open-history](https://github.com/AkiEga/file-open-history) — Tracks and shows your VS Code file opening history in a side editor or output channel
...
- [vscode-extension-tree](https://github.com/AkiEga/vscode-extension-tree) — Shows a folder's tree command output in VS Code as editable text or a read-only webview
- [vscode-msvs-proj-manager](https://github.com/AkiEga/vscode-msvs-proj-manager) — VS Code extension for parsing Visual Studio solution files and opening project root terminals
