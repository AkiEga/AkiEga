...
#### VS Code Extensions
- [file-open-history](https://github.com/AkiEga/file-open-history) — Tracks and shows your VS Code file opening history in a text editor or output panel
...
- [vscode-extension-section-info](https://github.com/AkiEga/vscode-extension-section-info) — Copies selected code sections and their file, line, and git details to the clipboard in custom formats
...
- [vscode-extension-tree](https://github.com/AkiEga/vscode-extension-tree) — Runs tree on a selected folder and shows the file tree in VS Code as editable text or a side webview
