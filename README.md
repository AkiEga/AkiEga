...
- [vscode-extension-section-info](https://github.com/AkiEga/vscode-extension-section-info) — Copies selected code section details and git context to the clipboard in customizable formats
...
- [vscode-extension-tree](https://github.com/AkiEga/vscode-extension-tree) — Runs the tree command on folders in VS Code and displays the file tree in an editor or webview
- [vscode-msvs-proj-manager](https://github.com/AkiEga/vscode-msvs-proj-manager) — A VS Code extension that parses Visual Studio solution files and opens terminals in project roots
