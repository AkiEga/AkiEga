...
- [vscode-extension-section-info](https://github.com/AkiEga/vscode-extension-section-info) — Copies selected code with file, line, function, and Git info to the clipboard in customizable formats
- [vscode-extension-svg-sketch](https://github.com/AkiEga/vscode-extension-svg-sketch) — Create and edit SVG diagrams in VS Code with a canvas-based editor and keyboard-friendly tools
- [vscode-extension-tree](https://github.com/AkiEga/vscode-extension-tree) — Shows a folder's tree command output in VS Code as editable text or a side-by-side webview
