...
#### VS Code Extensions
- [file-open-history](https://github.com/AkiEga/file-open-history) — Tracks and displays your VS Code file opening history in an editor pane or the Output channel
...
- [vscode-extension-svg-sketch](https://github.com/AkiEga/vscode-extension-svg-sketch) — Create and edit SVG diagrams in VS Code with a canvas-based editor and drawing tools
