...
#### VS Code Extensions
- [file-open-history](https://github.com/AkiEga/file-open-history) — Tracks and displays your VS Code file open history in a side editor or output channel
...
- [vscode-extension-section-info](https://github.com/AkiEga/vscode-extension-section-info) — Copies selected code section details and text to the clipboard in customizable formats with Git context
...
- [vscode-extension-tree](https://github.com/AkiEga/vscode-extension-tree) — Adds a VS Code Explorer action to run tree on folders and display the output in an editor or webview
- [vscode-msvs-proj-manager](https://github.com/AkiEga/vscode-msvs-proj-manager) — Parses Visual Studio .sln files in VS Code and opens terminals in project root directories
