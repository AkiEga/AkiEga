...
- [vscode-extension-section-info](https://github.com/AkiEga/vscode-extension-section-info) — Copies selected code sections with file, line, and Git info to the clipboard in customizable formats
...
- [vscode-extension-tree](https://github.com/AkiEga/vscode-extension-tree) — Displays a folder's tree command output in VS Code beside the Explorer as editable text or a webview
- [vscode-msvs-proj-manager](https://github.com/AkiEga/vscode-msvs-proj-manager) — VS Code extension for parsing Visual Studio solution files and opening terminals in project folders
