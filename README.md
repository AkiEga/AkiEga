...
- [vscode-extension-section-info](https://github.com/AkiEga/vscode-extension-section-info) — Copies selected code sections with file path, line numbers, git info, and language to the clipboard in customizable formats
- [vscode-extension-svg-sketch](https://github.com/AkiEga/vscode-extension-svg-sketch) — VS Code Extension for editting svg files with simple GUI
- [vscode-extension-tree](https://github.com/AkiEga/vscode-extension-tree) — tree command utilized vscode UI elements
