...
#### VS Code Extensions
- [file-open-history](https://github.com/AkiEga/file-open-history) — This extension outputs history of file opening actions in vscode
- [vscode-extension-ascii-sketch](https://github.com/AkiEga/vscode-extension-ascii-sketch) — VS Code extension to support to sketch ascii arts
