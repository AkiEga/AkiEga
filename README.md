...
#### VS Code Extensions
- [file-open-history](https://github.com/AkiEga/file-open-history) — Shows a history of files you open in VS Code in a side editor or output channel
...
- [vscode-msvs-proj-manager](https://github.com/AkiEga/vscode-msvs-proj-manager) — Helps manage Visual Studio solutions in VS Code by parsing .sln files and opening project root terminals
