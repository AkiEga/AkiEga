...
#### VS Code Extensions
- [file-open-history](https://github.com/AkiEga/file-open-history) — Tracks and shows your VS Code file open history in a side editor or output channel
...
- [vscode-extension-section-info](https://github.com/AkiEga/vscode-extension-section-info) — Copies selected code section info to the clipboard in customizable formats with file, line, and Git metadata
- [vscode-extension-svg-sketch](https://github.com/AkiEga/vscode-extension-svg-sketch) — A VS Code extension for creating and editing SVG diagrams in a canvas editor with Vim-style controls
- [vscode-extension-tree](https://github.com/AkiEga/vscode-extension-tree) — A VS Code extension that shows a folder's tree command output in an editor or webview panel
